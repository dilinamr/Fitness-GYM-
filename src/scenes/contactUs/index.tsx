      ...
      <div className="mt-10 justify-between gap-8 md:flex">
        ...
        >
          <form
            ...
            method="post"
            target="_blank"
            action="https://formsubmit.co/dilinam91@gmail.com"
          >
            <input
            ...
            {errors.name && (
              <p className="mt-1 text-primary-500">
                ...
                {errors.name.type === "maxLength" && "Max length is. 100char"}
              </p>
            )}
            <input
              className={inputstyle}
            ...
            {errors.email && (
              <p className="mt-1 text-primary-500">
                ...
                {errors.email.type === "pattern" && "Invaid email address"}
              </p>
            )}
            <textarea
              className={inputstyle}
        ...
        >
          <div className="before:content-evolvetext w-full before:absolute before:-bottom-20 before:-right-10 before:z-[-1]">
            <img src={ContactUsPageGraphic} alt="page img" className="w-full" />
          </div>
        </motion.div>
      </div>
    </section>
